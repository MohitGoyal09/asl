...
export default function ASLPage() {
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = () => {
        // Simulate translation for uploaded file
    ...
    <div className="container max-w-7xl mx-auto px-6 py-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          <Card className="p-6 shadow-lg">
            <Tabs defaultValue="camera" className="w-full">
              ...
              <TabsContent value="upload">
                <label className="aspect-video bg-muted/50 rounded-xl flex items-center justify-center border-2 border-dashed border-border/50 hover:border-primary/50 transition-colors cursor-pointer">
          ...
          <Card className="p-6 shadow-lg">
            <h3 className="font-semibold text-lg mb-6">Translation Settings</h3>
        ...
        <div className="space-y-6">
          ...
          {/* Translation History */}
          <Card className="p-6 shadow-lg">
            <h3 className="font-semibold text-lg mb-6">Recent Translations</h3>
