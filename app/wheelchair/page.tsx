...
const WheelchairMapPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="p-4 bg-white rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="flex items-center">
                ...
                ></div>
                <span>Limited wheelchair access (may require assistance)</span>
              </div>
            ...
            <h3 className="text-md font-semibold mt-4 mb-2">Feature Types:</h3>
      ...
      <footer className="p-4 bg-gray-200 text-center text-gray-700">
        <p>
